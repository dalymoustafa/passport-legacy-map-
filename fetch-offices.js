...
async function main() {
  ...
  const record = allRecords.find(r =>
    r.fields["Name"] && r.fields["Name"].toLowerCase().includes("passport legacy")
  );

  if (!record) { console.error("Could not find Passport Legacy!"); process.exit(1); }
...
<head>
  ...
  <title>Passport Legacy — Office Locations</title>
